        ...
        switch (apdu[0] & 0xF0) {
            case PDU_TYPE_CONFIRMED_SERVICE_REQUEST:
                ...
                if (service_choice == SERVICE_CONFIRMED_READ_PROPERTY) {
                	Confirmed_Function[SERVICE_CONFIRMED_READ_PROPERTY](service_request,
                			service_request_len, src, &service_data);
                }
#ifdef WRITE_PROPERTY
                else if (service_choice == SERVICE_CONFIRMED_WRITE_PROPERTY) {
                	Confirmed_Function[SERVICE_CONFIRMED_WRITE_PROPERTY](service_request,
                			service_request_len, src, &service_data);
                }
#endif
                else {
            ...
            case PDU_TYPE_UNCONFIRMED_SERVICE_REQUEST:
                ...
                if (service_choice == SERVICE_UNCONFIRMED_WHO_IS) {
                	Unconfirmed_Function[SERVICE_UNCONFIRMED_WHO_IS](service_request,
